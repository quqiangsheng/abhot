...
public class DeleteMetricsQuery extends SQLQuery
	...
	//---------------------------------------------------------------------------
	public DeleteMetricsQuery(String metricId, Timestamp startTime, Timestamp endTime)
		{
		super();
		m_metricId = metricId;
	...
	//---------------------------------------------------------------------------
	//Deprecated
	public int runUpdate(String metricId, Timestamp startTime, Timestamp endTime)
		{
		int ret = 0;
