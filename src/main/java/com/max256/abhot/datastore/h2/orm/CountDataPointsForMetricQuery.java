...
*/
public class CountDataPointsForMetricQuery extends SQLQuery
	{
	...
	//---------------------------------------------------------------------------
	public CountDataPointsForMetricQuery(String metricId, Timestamp startTime, Timestamp endTime)
		{
		super();
		m_metricId = metricId;
	...
	//---------------------------------------------------------------------------
	//Deprecated
	public ResultSet runQuery(String metricId, Timestamp startTime, Timestamp endTime)
		{
